...
- **Конфиг по умолчанию** – экспортируется для совместимости с командой `vite build --config engine/vite/config.mjs`, но основной сценарий использует `build.mjs`.
