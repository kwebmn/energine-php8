...
(4,3,3730,NULL,NULL,NULL,NULL,NULL),
(5,2,3741,NULL,NULL,NULL,NULL,'gfhdfghdfgh');
...
(64,9,'В процесі роботи виникли помилки'),
...
(67,9,'За замовчанням для гостей'),
...
(80,9,'Реєстрація пройшла успішно'),
(81,1,'Свойства'),
(81,2,'Властивості'),
(81,3,'Properties'),
(81,4,'Eigenschaften'),
...
(179,9,'Неправильний формат імені користувача. У полі повинні бути тільки латинські літери і цифри.'),
(186,1,'Редактор шаблонов'),
(186,2,'Редактор шаблонів'),
(186,3,'Template editor'),
(186,4,'Vorlageneditor'),
(186,5,'Edytor szablonów'),
(186,9,'Редактор шаблонів'),
(205,1,'Скачать файл'),
(205,2,'Скачати файл'),
(205,3,'Download file'),
...
(296,9,'На вказану вами адресу електронної пошти було відправлено новий пароль.'),
(297,1,'Забыли пароль?'),
(297,2,'Забули пароль?'),
...
(325,9,'<p>Налаштування користувача збережено.</p>'),
(326,1,'Фильтр'),
(326,2,'Фільтр'),
(326,3,'Filter'),
(326,4,'Filter'),
...
(330,9,'Зберегти і перейти до редагування'),
...
(331,9,'Ви хочете перейти до нової сторінки?'),
(336,1,'Название'),
(336,2,'Назва'),
(336,3,'Name'),
(336,4,'Name'),
...
(340,9,'Права групи за замовчанням'),
...
(343,9,'За вашим запитом товар не знайдено.'),
(344,1,'Главная'),
(344,2,'Головна'),
(344,3,'Main'),
(344,4,'Heim'),
...
(348,9,'Вихідний код текстового блоку'),
...
(365,9,'Змінити персональні дані'),
(367,1,'Новый пароль'),
(367,2,'Новий пароль'),
(367,3,'New password'),
...
(371,9,'Для збереження необхідно ввести пароль'),
(372,1,'Новый пароль'),
(372,2,'Новий пароль'),
(372,3,'New password'),
...
(375,9,'Ви ввели невірний пароль'),
...
(384,9,'Альтернативний title сторінки'),
...
(424,9,'Дякуємо за інтерес до наших продуктів. Ваше замовлення відправлено. Найближчим часом ми звяжемось з вами.'),
...
(438,9,'Вкажiть адресу електронної пошти, для вiдповiдi:'),
...
(440,9,'Ваше повідомлення успішно відправлено.'),
...
(447,9,'Додаткові файли відсутні'),
(448,1,'Удалить'),
(448,2,'Видалити'),
(448,3,'Delete'),
(448,4,'Löschen'),
...
(467,9,'Перенаправляти за адресою'),
...
(470,9,'Архів, що містить файли для завантаження'),
(471,1,'января'),
(471,2,'сiчня'),
(471,3,'January'),
(471,4,'Januar'),
...
(518,9,'Рівень прав, необхідний для перегляду товарів з цим статусом'),
(519,1,'Статус заказа'),
(519,2,'Статус замовлення'),
(519,3,'Order status'),
(519,4,'Bestellstatus'),
(519,5,'Status zamówienia'),
(519,9,'Статус замовлення'),
(524,1,'Тип товара'),
(524,2,'Тип товару'),
...
(556,9,'Абревіатура валюти повинна складатися з трьох латинських букв'),
(558,1,'Показать цены в'),
(558,2,'Відобразити ціни у'),
(558,3,'Show prices in'),
(558,4,'Preise anzeigen in'),
(558,5,'Pokaż ceny w'),
(558,9,'Відобразити ціни у'),
...
(579,9,'Будь-ласка, введіть цифри зображені на малюнку:'),
...
(580,9,'Ця електронна адреса вже використовується. Будь-ласка, використайте\nінший e-mail.'),
(587,1,'Протокол'),
(587,2,'Протокол'),
(587,3,'Protocol'),
(587,4,'Protokoll'),
...
(652,9,'Короткий текст про керівника'),
...
(653,9,'Повний текст про керівника'),
(660,1,'Скрыть версию'),
(660,2,'Сховати версію'),
(660,3,'Hide version'),
(660,4,'Version ausblenden'),
(660,5,'Ukryj wersję'),
(660,9,'Сховати версію'),
...
(665,9,'Дата початку кастингу'),
(666,1,'Название кастинга'),
(666,2,'Назва кастингу'),
(666,3,'Casting name'),
(666,4,'Casting-Name'),
(666,5,'Casting nazwa'),
(666,9,'Назва кастингу'),
...
(667,9,'Короткий текст про кастинг'),
...
(825,4,'Startseite'),
(825,5,'Strona główna'),
(825,9,'Головна сторінка'),
(826,1,'Главная страница'),
(826,2,'Головна сторінка'),
(826,3,'Main page'),
(826,4,'Hauptseite'),
(826,5,'Strona główna'),
(826,9,'Головна сторінка'),
(827,1,'Новое фото'),
(827,2,'Нове фото'),
(827,3,'New photo'),
(827,4,'Neues Foto'),
...
(841,9,'Форма зворотнього зв\'язку'),
(842,1,'Список обратной связи'),
(842,2,'Список зворотнього зв\'язку'),
(842,3,'Feedback list'),
(842,4,'Feedbackliste'),
(842,5,'Lista opinii'),
(842,9,'Список зворотнього зв\'язку'),
(848,1,'Видео'),
(848,2,'Відео'),
(848,3,'Video'),
(848,4,'Video'),
...
(856,9,'Редактор категорій новин'),
(858,1,'Редактор тегов'),
(858,2,'Редактор тегів'),
(858,3,'TAG editor'),
(858,4,'TAG-Editor'),
(858,5,'edytor TAG'),
(858,9,'Редактор тегів'),
...
(875,9,'Виводити на головну сторінку'),
(876,1,'Топ'),
(876,2,'Топ'),
(876,3,'Top'),
(876,4,'Oben'),
...
(899,9,'Відступ верхнього правого зображення'),
...
(905,9,'Властивості нижнього фонового зображення'),
...
(906,9,'Верхнє фонове зображення'),
...
(907,9,'Властивості верхнього фонового зображення'),
...
(910,9,'Змінити розміри зображення до стандартних'),
(912,1,'Ответить'),
(912,2,'Відповісти'),
(912,3,'Reply'),
(912,4,'Antwort'),
...
(979,9,'переглянути усі кастінги'),
(983,1,'Поддержали'),
(983,2,'Підтримали'),
(983,3,'Supported'),
(983,4,'Unterstützt'),
...
(987,9,'Редактор запитів артистів'),
(991,1,'Телефон'),
(991,2,'Телефон'),
(991,3,'Telephone'),
(991,4,'Telefon'),
...
(1003,9,'Повідомлення з форми зворотнього зв\'язку'),
...
(1015,9,'Редактор заборонених IP'),
(1016,1,'Время бана'),
(1016,2,'Час бану'),
(1016,3,'Ban time'),
(1016,4,'Sperrzeit'),
...
(1022,9,'Редактор бана користувача'),
(1023,1,'Время бана'),
(1023,2,'Час бану'),
(1023,3,'Ban time'),
(1023,4,'Bannzeit'),
...
(1053,9,'Порядок сортування'),
(1057,1,'Заголовок блока'),
(1057,2,'Заголовок блоку'),
(1057,3,'Block title'),
(1057,4,'Blocktitel'),
(1057,5,'Tytuł bloku'),
(1057,9,'Заголовок блоку'),
...
(1073,9,'Сегмент сторінки виводу'),
(1077,1,'Маска вывода'),
(1077,2,'Маска виводу'),
(1077,3,'Output mask'),
(1077,4,'Ausgabemaske'),
...
(1097,9,'Редактор вихідного коду текстового блоку'),
...
(1146,9,'Текстова сторінка з медіа-файлами'),
(1147,1,'содержит'),
(1147,2,'містить'),
(1147,3,'contains'),
(1147,4,'enthält'),
...
(1150,9,'Номер текстового блоку на сторінці'),
...
(1151,9,'Включити у вивід також всі записи із вкладених підрозділів'),
...
(1163,9,'E-mail, на який надходять заповнені форми'),
(1164,1,'Описание'),
(1164,2,'Опис'),
(1164,3,'Description'),
(1164,4,'Beschreibung'),
...
(1167,9,'Поле може бути порожнім'),
(1168,1,'строка'),
(1168,2,'рядок'),
(1168,3,'Line'),
(1168,4,'Linie'),
...
(1187,9,'Нове повідомлення з форми'),
...
(1203,9,'Конструктор форм: результати'),
...
(1206,9,'Параметри індексування сторінки (значення meta-тега robots)'),
...
(1225,9,'<a class=\"btn_save\" href=\"#\"></a>\n<script type=\"text/javascript\">\nGameResults = {\n\'score\':%s,\n\'time\':%s,\n\'saveURL\':\'%s\',\n\'restartURL\':\'%s\'\n}\n</script>\n<a class=\"btn_again\" href=\"#\"></a>'),
(1226,1,'Подпроект'),
(1226,2,'Підпроект'),
(1226,3,'Subproject'),
(1226,4,'Teilprojekt'),
...
(1232,9,'Колір фону (шістнадцятковий код, наприклад #c0c0c0)'),
...
(1233,9,'CSS-правило, що задає поведінку фонового зображення (наприклад, center top no-repeat)'),
...
(1234,9,'Мінімальна висота блоку з фоновим зображенням'),
...
(1235,9,'Колірна схема для сторінки'),
...
(1243,9,'Широка текстова сторінка'),
...
(1244,9,'Головна сторінка підпроекту'),
(1245,1,'Игра начата'),
(1245,2,'Гру почато'),
...
(1261,9,'Коротка інформація про співробітника'),
...
(1268,9,'Фото відповіді(повне) 212х280'),
(1269,1,'Изображение'),
(1269,2,'Зображення'),
(1269,3,'Image'),
(1269,4,'Bild'),
...
(1282,9,'Список новин підпроекту'),
...
(1283,9,'Текстова сторінка підпроекту'),
...
(1284,9,'Широка текстова сторінка підпроекту'),
(1285,1,'Телефон'),
(1285,2,'Телефон'),
(1285,3,'Telephone'),
(1285,4,'Telefon'),
...
(1362,9,'Сегмент новини (буде виведений в URL новини замість числового ідентифікатора)'),
(1364,1,'Категория'),
(1364,2,'Категорія'),
(1364,3,'Category'),
(1364,4,'Kategorie'),
...
(1366,9,'Показувати приєднане зображення у повному тексті новини'),
...
(1426,9,'Публікувати фотогалерею'),
...
(1427,9,'Публікувати фотогалерею'),
...
(1428,9,'Публікувати фотогалерею починаючи з цієї дати'),
(1429,1,'Фотогалерея'),
(1429,2,'Фотогалерея'),
...
(1431,5,'Nie ma zdjęć'),
(1431,9,'Немає жодної фотографії.'),
...
(1432,9,'Кількість записів на сторінці'),
...
(1446,9,'Компонент, що містить список категорій'),
...
(1447,9,'Прив\'язаний до компоненту'),
...
(1510,9,'Відображати на головній'),
...
(1552,5,'Adres e-mail:'),
(1552,9,'Адрес электронной почты:'),
(1554,1,'Телефон:'),
(1554,2,'Телефон:'),
(1554,3,'Telephone:'),
(1554,4,'Telefon:'),
...
(1566,9,'<span class=\"mark\">**</span> На указанный Вами электронный адрес будет выслан автоматически созданный пароль'),
...
(1568,9,'Пользователь с таким e-mail уже зарегистрирован.\nВойдите в систему под другим аккаунтом или зарегистрируйте новый аккаунт на другой e-mail.'),
(1574,1,'очистить'),
(1574,2,'очистить'),
(1574,3,'clear'),
(1574,4,'löschen'),
...
(1580,9,'Спасибо за Ваше желание сотрудничать! Ваше резюме будет обязательно рассмотрено.'),
...
(1582,9,'Новый отклик на вакансию'),
...
(1584,9,'Отклик можно просмотреть в разделе  \"Просмотр откликов на вакасии\" админ части системы.'),
(1586,1,'Дата:'),
(1586,2,'Дата:'),
(1586,3,'Date:'),
(1586,4,'Datum:'),
...
(1594,9,'Альтернативное имя ссылки \"подробнее\"'),
...
(1603,9,'Пользователь с таким почтовым ящиком уже существует.'),
(1604,1,'популярные'),
(1604,2,'популярні'),
(1604,3,'Popular'),
(1604,4,'Beliebt'),
...
(1612,9,'<strong>Пн-Пт</strong> 7:00, 17:00, 19:00\n<br/><strong>Сб</strong> 19:00'),
(1614,1,'Саундтреки'),
(1614,2,'Саундтреки'),
(1614,3,'Soundtracks'),
(1614,4,'Soundtracks'),
...
(1644,9,'Альтернативное изображение для таймлайна'),
(1648,1,'Тип выпуска'),
(1648,2,'Тип випуску'),
(1648,3,'Issue type'),
(1648,4,'Ausgabetyp'),
...
(1686,9,'Текстовий редактор блогу'),
(1688,1,'Дата'),
(1688,2,'Дата'),
(1688,3,'Date'),
(1688,4,'Datum'),
...
(1800,9,'Спсиок прем\'єр на головній'),
...
(1838,9,'Изображение для списков (190х132)'),
...
(1840,9,'Отображаемое изображение (190х192)'),
(1842,1,'Изображение (48х48)'),
(1842,2,'Изображение (48х48)'),
(1842,3,'Image (48х48)'),
(1842,4,'Bild (48x48)'),
(1842,5,'Obraz (48x48)'),
(1842,9,'Изображение (48х48)'),
...
(1844,9,'Маленькое изображение (100х70)'),
...
(1910,9,'Інтереси, захоплення, таланти'),
(1912,1,'Страна'),
(1912,2,'Країна'),
(1912,3,'Country'),
(1912,4,'Land'),
...
(1924,9,'(якщо ви вказуєте домашній номер телефону, обов\'язково вкажіть код міста)'),
...
(1936,9,'Подписка на новости. Активация почтового ящика.'),
...
(1938,9,'Подписка на новости. Активация почтового ящика.'),
...
(1940,9,'Для активации пройдите по ссылке:\n%sverify-email/%s/'),
...
(1944,9,'Неправильный формат email адреса.'),
...
(1954,9,'Підписатися на розсилку новин'),
(1958,1,'Ваш электронный адрес'),
(1958,2,'Ваша електронна адреса'),
(1958,3,'Your email'),
(1958,4,'Ihre E-Mail'),
(1958,5,'Twój e-mail'),
(1958,9,'Ваша електронна адреса'),
(1960,1,'Подписаться'),
(1960,2,'ПІдписатися'),
(1960,3,'Subscribe'),
(1960,4,'Abonnieren'),
...
(1972,9,'Форма зворотнього зв\'язку'),
...
(1974,9,'Дякуємо за те, що Ви залишили нам повідомлення. Незабаром воно буде розглянуте.'),
(1976,1,'Тема'),
(1976,2,'Тема'),
(1976,3,'Topic'),
(1976,4,'Thema'),
...
(2018,9,'Редактор отримувачів повідомлень'),
...
(2021,5,'Adres e-mail'),
(2021,9,'Адреса електронної пошти'),
(2022,1,'Телефон'),
(2022,2,'Телефон'),
(2022,3,'Telephone'),
(2022,4,'Telefon'),
...
(2036,9,'Ви дійсно бажаєте видалити обраний коментар?'),
(2037,1,'Опубликовать'),
(2037,2,'Опублікувати'),
(2037,3,'Publish'),
...
(2039,9,'Не введено адресу електронної пошти'),
...
(2473,9,'Спасибі, ми зв\'яжемося з Вами найближчим часом.'),
...
(2475,9,'URL: <a href=\"$url\">$product_name</a><br>\nPhone: $phone'),
...
(2479,9,'Всі коментарі, які не стосуються продукту, будуть видалені!'),
...
(2480,9,'Коментар буде виведений тільки після попередньої перевірки нашими\nспівробітниками.'),
(2481,1,'Ваше Имя'),
(2481,2,'Ваше ім\'я'),
(2481,3,'Your name'),
(2481,4,'Dein Name'),
...
(2488,9,'Ваш коментар успішно відправлений!'),
(2489,1,'Отзывы'),
(2489,2,'Відгуки'),
(2489,3,'Reviews'),
(2489,4,'Bewertungen'),
...
(1112465,9,'Персональний кабінет'),
...
) ENGINE=InnoDB AUTO_INCREMENT=1126 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
(1119,'8c10df862a2484d3ac7d929542c92d57',1759904841,1759891752,1760660841,2130706433,NULL,22,'userID|i:22;'),
(1122,'8db8a96f831ba725a8d3432847d6ea72',1760267261,1759990812,1761023261,2130706433,NULL,22,'userID|i:22;'),
(1123,'8db6ca9e3348be0c047a31f2c14b04df',1760437962,1760003846,1761193962,2130706433,NULL,22,'userID|i:22;'),
(1124,'fbc3beb9041c38c507834c4c352d62c5',1760444089,1760438007,1761200089,2130706433,NULL,22,'userID|i:22;'),
(1125,'21cc20982bf5ba459f75b8782cdac752',1760447583,1760441152,1761203583,2130706433,NULL,22,'userID|i:22;');
...
(80,1,'default.layout.xml',NULL,'textblock.content.xml',NULL,NULL,'',538,NULL,NULL),
...
(3727,1,'default.layout.xml',NULL,'test_editor.content.xml',NULL,80,'test',3,NULL,NULL),
...
(3730,1,'account.layout.xml',NULL,'Testfeed.content.xml',NULL,80,'test2',4,NULL,NULL),
...
(3741,1,'default.layout.xml',NULL,'Testfeed.content.xml',NULL,3730,'5555',2,NULL,NULL);
...
(11,3730,32009,2,'74bcf3cadc2ad6fc25076ef3250b0112'),
(12,3730,32004,2,'fd1266ebd9819a95d8dd816c52091b8c');
...
(10,2,'<p style=\"text-align:justify;\">32132321322132122311333123</p>\n\n<p style=\"text-align:justify;\">123123</p>\n\n<p><img align=\"middle\" alt=\"usch3.jpg\" src=\"uploads/public/fast-upload/1759997797589.jpg\" style=\"border-width:0px;border-style:solid;width:500px;height:333px;\" /></p>\n\n<p> </p>\n\n<p> </p>\n\n<p class=\"underline\">as<sup>d</sup><img alt=\"68e694849f30e.webp\" src=\"uploads/public/fast-upload/17599948549665.webp\" style=\"border-width:0px;border-style:solid;width:700px;height:467px;\" /></p>\n\n<h3> </h3>\n\n<p>апр</p>\n\n<p> 1</p>\n\n<p> </p>\n\n<p> 11</p>\n\n<p> </p>\n\n<p> </p>\n\n<p> </p>\n\n<p> </p>\n\n<p> </p>\n\n<p> </p>\n\n<p> </p>\n\n<p> </p>\n\n<p>222</p>\n\n<p> </p>\n'),
(10,3,'<p>-- asasasa1</p>\n\n<p> </p>\n'),
...
) ENGINE=InnoDB AUTO_INCREMENT=32064 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
(1,NULL,0,'uploads/public','public','public','Локальный репозиторий',NULL,'2025-10-14 09:41:52',NULL,0,'repo','repo/local',0,0,0,NULL,NULL,1,NULL,1),
(14,1,NULL,'uploads/public/gallery','gallery','gallery','Gallery',NULL,'2025-10-14 09:41:52',NULL,0,'folder','unknown/mime-type',0,0,0,NULL,NULL,1,NULL,1),
(19,1,NULL,'uploads/public/fast-upload','fast-upload','fast-upload','Fast Upload',NULL,'2025-10-09 11:16:37',NULL,0,'folder','unknown/mime-type',0,0,0,NULL,NULL,1,NULL,1),
...
(32063,14,NULL,'uploads/public/gallery/17604241128814.jpg','17604241128814.jpg','3611.jpg','3611',NULL,'2025-10-14 09:41:52',NULL,0,'image','image/jpeg',0,0,0,1500,1000,1,NULL,1);
...
-- Dump completed on 2025-10-14 13:13:08
