...
(1986,5,'Przenieś'),
(1986,9,'Переместить'),
(2014,1,'Электронная почта'),
(2014,2,'Електронна пошта'),
(2014,3,'Email'),
(2014,4,'E-Mail'),
(2014,5,'E-mail'),
(2014,9,'Електронна пошта'),
...
(1112470,1,'© 2025 Все права защищены.'),
(1112470,2,'© 2025 Усі права захищені.'),
(1112470,3,'© 2025 All rights reserved.'),
(1112470,4,'© 2025 Alle Rechte vorbehalten.'),
(1112470,5,'© 2025 Wszelkie prawa zastrzeżone.'),
(1112470,9,'© 2025 Усі права захищені.'),
...
(1112477,1,'<p>Уважаемый пользователь!</p>\n<p>Мы получили от вас запрос на изменение пароля для вашей учетной записи в системе.</p>\n<p>Чтобы изменить пароль, перейдите по ссылке ниже.</p>\n<p><a href="$link">$link</a></p>\n<p>Ссылка будет доступна в течение 24 часов или до следующего запроса на смену пароля.</p>'),
(1112477,2,'<p>Шановний користувачу!</p>\n<p>Ми отримали від вас запит на зміну пароля для вашого облікового запису в системі.</p>\n<p>Щоб змінити пароль, перейдіть за посиланням нижче.</p>\n<p><a href="$link">$link</a></p>\n<p>Посилання буде доступне протягом 24 годин або до наступного запиту на зміну пароля.</p>'),
...
(1112477,4,'<p>Sehr geehrte Nutzerin, sehr geehrter Nutzer!</p>\n<p>Wir haben von Ihnen die Anfrage erhalten, das Passwort für Ihr Konto im System zu ändern.</p>\n<p>Um Ihr Passwort zu ändern, klicken Sie auf den folgenden Link.</p>\n<p><a href="$link">$link</a></p>\n<p>Der Link ist 24 Stunden lang oder bis zu Ihrer nächsten Anfrage zur Passwortänderung verfügbar.</p>'),
(1112477,5,'<p>Szanowny Użytkowniku!</p>\n<p>Otrzymaliśmy od Ciebie prośbę o zmianę hasła do Twojego konta w systemie.</p>\n<p>Aby zmienić hasło, kliknij poniższy link.</p>\n<p><a href="$link">$link</a></p>\n<p>Link będzie dostępny przez 24 godziny lub do czasu kolejnej prośby o zmianę hasła.</p>'),
(1112477,9,'<p>Шановний користувачу!</p>\n<p>Ми отримали від вас запит на зміну пароля для вашого облікового запису в системі.</p>\n<p>Щоб змінити пароль, перейдіть за посиланням нижче.</p>\n<p><a href="$link">$link</a></p>\n<p>Посилання буде доступне протягом 24 годин або до наступного запиту на зміну пароля.</p>'),
(1112478,1,'Пароль изменён'),
(1112478,2,'Пароль змінено'),
(1112478,3,'Password changed'),
(1112478,4,'Passwort wurde geändert'),
(1112478,5,'Hasło zostało zmienione'),
(1112478,9,'Пароль змінено'),
